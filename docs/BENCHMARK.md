# MioNeko Benchmark & Cache Validation

## 概述

本文档说明如何验证 MioNeko 的缓存机制和性能指标。
...
验证 MioNeko 的前缀构建是否稳定，即相同输入是否产生相同的 prefix fingerprint。

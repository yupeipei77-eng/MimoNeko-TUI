...
NekoForge is NekoMIMO's local terminal AI coding workbench. It keeps NekoMIMO as the underlying engine and adds a minimal silver-cyan console entry point:
